from dijkstra import DijkstraAlgorithm, Node, Edge
...
peakList = (node1, node2, node3, node4, node5, node6, node7, node8)

algorithm = DijkstraAlgorithm()
algorithm.calculateShortestPath(peakList, node1)
